...
@curl http://github.com/kennethreitz/krzsh/raw/master/tools/install.sh | sh@
...
1. Clone the repository
  ...
  @git clone git://github.com/kennethreitz/krzsh.git ~/.oh-my-zsh@
...
** Take a look at the "current themes":http://wiki.github.com/kennethreitz/oh-my-zsh/themes that come bundled with _Oh My Zsh_.
